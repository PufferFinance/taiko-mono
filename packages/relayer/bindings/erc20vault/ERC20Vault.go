...
func (_ERC20Vault *ERC20VaultTransactor) Init(opts *bind.TransactOpts, _owner common.Address, _sharedAddressManager common.Address) (*types.Transaction, error) {
	return _ERC20Vault.contract.Transact(opts, "init", _owner, _sharedAddressManager)
}

// Init is a paid mutator transaction binding the contract method 0xf09a4016.
//
// Solidity: function init(address _owner, address _sharedAddressManager) returns()
func (_ERC20Vault *ERC20VaultSession) Init(_owner common.Address, _sharedAddressManager common.Address) (*types.Transaction, error) {
	return _ERC20Vault.Contract.Init(&_ERC20Vault.TransactOpts, _owner, _sharedAddressManager)
}

// Init is a paid mutator transaction binding the contract method 0xf09a4016.
//
// Solidity: function init(address _owner, address _sharedAddressManager) returns()
func (_ERC20Vault *ERC20VaultTransactorSession) Init(_owner common.Address, _sharedAddressManager common.Address) (*types.Transaction, error) {
	return _ERC20Vault.Contract.Init(&_ERC20Vault.TransactOpts, _owner, _sharedAddressManager)
}
