...
func (_ERC1155Vault *ERC1155VaultTransactor) Init(opts *bind.TransactOpts, _owner common.Address, _sharedAddressManager common.Address) (*types.Transaction, error) {
	return _ERC1155Vault.contract.Transact(opts, "init", _owner, _sharedAddressManager)
}

// Init is a paid mutator transaction binding the contract method 0xf09a4016.
//
// Solidity: function init(address _owner, address _sharedAddressManager) returns()
func (_ERC1155Vault *ERC1155VaultSession) Init(_owner common.Address, _sharedAddressManager common.Address) (*types.Transaction, error) {
	return _ERC1155Vault.Contract.Init(&_ERC1155Vault.TransactOpts, _owner, _sharedAddressManager)
}

// Init is a paid mutator transaction binding the contract method 0xf09a4016.
//
// Solidity: function init(address _owner, address _sharedAddressManager) returns()
func (_ERC1155Vault *ERC1155VaultTransactorSession) Init(_owner common.Address, _sharedAddressManager common.Address) (*types.Transaction, error) {
	return _ERC1155Vault.Contract.Init(&_ERC1155Vault.TransactOpts, _owner, _sharedAddressManager)
}
