...
func (_SignalService *SignalServiceTransactor) Init(opts *bind.TransactOpts, _owner common.Address, _sharedAddressManager common.Address) (*types.Transaction, error) {
	return _SignalService.contract.Transact(opts, "init", _owner, _sharedAddressManager)
}

// Init is a paid mutator transaction binding the contract method 0xf09a4016.
//
// Solidity: function init(address _owner, address _sharedAddressManager) returns()
func (_SignalService *SignalServiceSession) Init(_owner common.Address, _sharedAddressManager common.Address) (*types.Transaction, error) {
	return _SignalService.Contract.Init(&_SignalService.TransactOpts, _owner, _sharedAddressManager)
}

// Init is a paid mutator transaction binding the contract method 0xf09a4016.
//
// Solidity: function init(address _owner, address _sharedAddressManager) returns()
func (_SignalService *SignalServiceTransactorSession) Init(_owner common.Address, _sharedAddressManager common.Address) (*types.Transaction, error) {
	return _SignalService.Contract.Init(&_SignalService.TransactOpts, _owner, _sharedAddressManager)
}
