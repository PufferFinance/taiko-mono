...
func (_ERC721Vault *ERC721VaultTransactor) Init(opts *bind.TransactOpts, _owner common.Address, _sharedAddressManager common.Address) (*types.Transaction, error) {
	return _ERC721Vault.contract.Transact(opts, "init", _owner, _sharedAddressManager)
}

// Init is a paid mutator transaction binding the contract method 0xf09a4016.
//
// Solidity: function init(address _owner, address _sharedAddressManager) returns()
func (_ERC721Vault *ERC721VaultSession) Init(_owner common.Address, _sharedAddressManager common.Address) (*types.Transaction, error) {
	return _ERC721Vault.Contract.Init(&_ERC721Vault.TransactOpts, _owner, _sharedAddressManager)
}

// Init is a paid mutator transaction binding the contract method 0xf09a4016.
//
// Solidity: function init(address _owner, address _sharedAddressManager) returns()
func (_ERC721Vault *ERC721VaultTransactorSession) Init(_owner common.Address, _sharedAddressManager common.Address) (*types.Transaction, error) {
	return _ERC721Vault.Contract.Init(&_ERC721Vault.TransactOpts, _owner, _sharedAddressManager)
}
