...
// Anchor is a paid mutator transaction binding the contract method 0x18b1073d.
//
// Solidity: function anchor(bytes32 , bytes32 _l1StateRoot, bytes32 _depositsRoot, uint64 _l1BlockId, uint32 _parentGasUsed) returns()
func (_TaikoL2Client *TaikoL2ClientTransactor) Anchor(opts *bind.TransactOpts, arg0 [32]byte, _l1StateRoot [32]byte, _depositsRoot [32]byte, _l1BlockId uint64, _parentGasUsed uint32) (*types.Transaction, error) {
	return _TaikoL2Client.contract.Transact(opts, "anchor", arg0, _l1StateRoot, _depositsRoot, _l1BlockId, _parentGasUsed)
}

// Anchor is a paid mutator transaction binding the contract method 0x18b1073d.
//
// Solidity: function anchor(bytes32 , bytes32 _l1StateRoot, bytes32 _depositsRoot, uint64 _l1BlockId, uint32 _parentGasUsed) returns()
func (_TaikoL2Client *TaikoL2ClientSession) Anchor(arg0 [32]byte, _l1StateRoot [32]byte, _depositsRoot [32]byte, _l1BlockId uint64, _parentGasUsed uint32) (*types.Transaction, error) {
	return _TaikoL2Client.Contract.Anchor(&_TaikoL2Client.TransactOpts, arg0, _l1StateRoot, _depositsRoot, _l1BlockId, _parentGasUsed)
}

// Anchor is a paid mutator transaction binding the contract method 0x18b1073d.
//
// Solidity: function anchor(bytes32 , bytes32 _l1StateRoot, bytes32 _depositsRoot, uint64 _l1BlockId, uint32 _parentGasUsed) returns()
func (_TaikoL2Client *TaikoL2ClientTransactorSession) Anchor(arg0 [32]byte, _l1StateRoot [32]byte, _depositsRoot [32]byte, _l1BlockId uint64, _parentGasUsed uint32) (*types.Transaction, error) {
	return _TaikoL2Client.Contract.Anchor(&_TaikoL2Client.TransactOpts, arg0, _l1StateRoot, _depositsRoot, _l1BlockId, _parentGasUsed)
}

// AnchorV2 is a paid mutator transaction binding the contract method 0x47fa2a64.
//
// Solidity: function anchorV2(uint64 _anchorBlockId, bytes32 _anchorStateRoot, bytes32 _anchorDepositsRoot, uint32 _parentGasUsed, (uint8,uint8,uint32,uint64,uint32) _baseFeeConfig) returns()
func (_TaikoL2Client *TaikoL2ClientTransactor) AnchorV2(opts *bind.TransactOpts, _anchorBlockId uint64, _anchorStateRoot [32]byte, _anchorDepositsRoot [32]byte, _parentGasUsed uint32, _baseFeeConfig TaikoDataBaseFeeConfig) (*types.Transaction, error) {
	return _TaikoL2Client.contract.Transact(opts, "anchorV2", _anchorBlockId, _anchorStateRoot, _anchorDepositsRoot, _parentGasUsed, _baseFeeConfig)
}

// AnchorV2 is a paid mutator transaction binding the contract method 0x47fa2a64.
//
// Solidity: function anchorV2(uint64 _anchorBlockId, bytes32 _anchorStateRoot, bytes32 _anchorDepositsRoot, uint32 _parentGasUsed, (uint8,uint8,uint32,uint64,uint32) _baseFeeConfig) returns()
func (_TaikoL2Client *TaikoL2ClientSession) AnchorV2(_anchorBlockId uint64, _anchorStateRoot [32]byte, _anchorDepositsRoot [32]byte, _parentGasUsed uint32, _baseFeeConfig TaikoDataBaseFeeConfig) (*types.Transaction, error) {
	return _TaikoL2Client.Contract.AnchorV2(&_TaikoL2Client.TransactOpts, _anchorBlockId, _anchorStateRoot, _anchorDepositsRoot, _parentGasUsed, _baseFeeConfig)
}

// AnchorV2 is a paid mutator transaction binding the contract method 0x47fa2a64.
//
// Solidity: function anchorV2(uint64 _anchorBlockId, bytes32 _anchorStateRoot, bytes32 _anchorDepositsRoot, uint32 _parentGasUsed, (uint8,uint8,uint32,uint64,uint32) _baseFeeConfig) returns()
func (_TaikoL2Client *TaikoL2ClientTransactorSession) AnchorV2(_anchorBlockId uint64, _anchorStateRoot [32]byte, _anchorDepositsRoot [32]byte, _parentGasUsed uint32, _baseFeeConfig TaikoDataBaseFeeConfig) (*types.Transaction, error) {
	return _TaikoL2Client.Contract.AnchorV2(&_TaikoL2Client.TransactOpts, _anchorBlockId, _anchorStateRoot, _anchorDepositsRoot, _parentGasUsed, _baseFeeConfig)
}
