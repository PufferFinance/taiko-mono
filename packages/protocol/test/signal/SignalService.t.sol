...
contract MockSignalService is SignalServiceL1 {
...
contract TestSignalService is TaikoTest {
    ...
    SignalServiceL1 realSignalService;
    ...
    function setUp() public {
        ...
        realSignalService = SignalServiceL1(
            deployProxy({
                name: "signal_service",
                impl: address(new SignalServiceL1()),
                data: abi.encodeCall(SignalServiceL1.init, (Alice, address(addressManager)))
            })
        );
    ...
    function test_SignalService_proveSignalReceived_revert_zero_size_proof() public {
        ...
        vm.expectRevert(SignalServiceL1.SS_EMPTY_PROOF.selector);
        signalService.proveSignalReceived({
            _chainId: srcChainId,
            _app: randAddress(),
            _signal: randBytes32(),
    ...
    function test_SignalService_proveSignalReceived_revert_last_hop_incorrect_chainid() public {
        ...
        vm.expectRevert(SignalServiceL1.SS_INVALID_LAST_HOP_CHAINID.selector);
        signalService.proveSignalReceived({
            _chainId: srcChainId,
            _app: randAddress(),
            _signal: randBytes32(),
    ...
    function test_SignalService_proveSignalReceived_revert_mid_hop_incorrect_chainid() public {
        ...
        vm.expectRevert(SignalServiceL1.SS_INVALID_MID_HOP_CHAINID.selector);
        signalService.proveSignalReceived({
            _chainId: srcChainId,
            _app: randAddress(),
            _signal: randBytes32(),
    ...
    function test_SignalService_proveSignalReceived_local_chaindata_not_found() public {
        ...
        vm.expectRevert(SignalServiceL1.SS_SIGNAL_NOT_FOUND.selector);
        signalService.proveSignalReceived({
            _chainId: srcChainId,
            _app: randAddress(),
            _signal: randBytes32(),
    ...
    function test_SignalService_proveSignalReceived_one_hop_cache_signal_root() public {
        ...
        vm.expectRevert(SignalServiceL1.SS_UNAUTHORIZED.selector);
        vm.prank(taiko);
        signalService.syncChainData(
            srcChainId, LibStrings.H_SIGNAL_ROOT, proofs[0].blockId, proofs[0].rootHash
        );
    ...
    function test_SignalService_proveSignalReceived_revert_with_a_loop() public {
        ...
        vm.expectRevert(SignalServiceL1.SS_INVALID_HOPS_WITH_LOOP.selector);
        signalService.proveSignalReceived({
            _chainId: srcChainId,
            _app: randAddress(),
            _signal: randBytes32(),
